...
NUN_AUTO_PARTIED            = "Party. Auto-Noted on : ";
NUN_RESET                   = "Reset ";
NUN_SEARCH                  = "Search";
NUN_CLOSE                   = "Close";
...
NUN_LEVEL_TXT = "Account Level";

NUN_CHAT_HEADER = "Send Note";
NUN_CHAT_NOTETITLE_LABEL = "Note Title : ";
NUN_CHAT_DROPDOWN_LABEL = "Send Note to...";
NUN_CHAT_SEND = "Transmit";
NUN_CHATCHECKBOX_LABEL = "Only send Scroll Box Text";
NUN_CHATFORMATCHECKBOX_LABEL = "Send Formatted Note";
...
NUN_TRANSMISSION_WARNING =
" ! Formatted Note details will be visible to channel subscribers without NotesUNeed. Take care not to Spam ! ";

NUN_TRANSMISSION_ERROR = "Error Occurred constructing NotesUNeed message for Transmission : ";
NUN_TRANSMISSION_MISSING = "Note not Found !";
NUN_COLOUR_ERROR_REPORT =
"Malformed Colour Codes in Body of Scroll Text : Sending via Chat would probably result in Disconnect From Server !";
NUN_NONCRITICAL_ERROR = "Non-critical Error(s) occurred. See transmission log in Note : ";
NUN_LINEERROR_TEXT = "Line in Error ";
NUN_BOGUSITEM_TEXT = "Invalid Item for Server";

NUN_CONFLICT_LABEL1 = "Saving this Note at Account Level will replace";
NUN_CONFLICT_LABEL2 = "  Server Level Notes on the following Realms :";


NUN_FRAME_SCALE_TXT = "Frames";
NUN_FONT_SCALE_TXT = "Tooltips";
NUN_MAPNOTES_TXT = "MapNote";
NUN_NOMAPNOTES = "|cffff0000MapNotes AddOn  NOT  Present|r";


NUN_QUEST = "Quest : ";

NUN_DUPLICATE = "A NotesUNeed Note Already\nExists with that Name";
NUN_TEXTLIM1 = "NotesUNeed Text Limit of ";
NUN_TEXTLIM2 = " Exceeded\nSome text may not be saved.\n";


NUN_TTLENGTH_TEXTBOX_LABEL = "Enter the maximum number of characters to appear in Tooltips : ";
NUN_DEFAULTLEVEL_CHECKBOX_LABEL = "Save General Notes at Account Level by Default";
NUN_SHOWHELPTT_CHECKBOX_LABEL = "Show NotesUNeed Tooltips";
NUN_MINOVERTT_CHECKBOX_LABEL = "Minimise MouseOver Target Tooltips";
NUN_CHAT_CHECKBOX_LABEL = "Show Chat Tags";
NUN_AUTONOTE_CHECKBOX_LABEL = "Auto-maintain a note for current character";
NUN_QUESTNOTE_CHECKBOX_LABEL = "Auto-maintain notes on Quest Log entries & History";
NUN_AUTOPARTY_CHECKBOX_LABEL = "Auto-maintain notes on Party Members";
NUN_BEHAVE_CHECKBOX_LABEL = "Alternative Note Edit Frame Behaviour";
NUN_TTTOTAL_LABEL = "Total";
NUN_TTLINEL_LABEL = "~ Per Line";
NUN_AUTOMAP_CHECKBOX_LABEL = "Auto-MapNote NPCs";
NUN_FONT_CHECKBOX_LABEL = "NuN Font";
NUN_GUILDREFRESH_CHECKBOX_LABEL = "	Auto-Guild Notes";
NUN_GRVERBOSE_CHECKBOX_LABEL = "Verbose Guild Noting";
NUN_MODIFIER_CHECKBOX_LABEL = "Enable NotesUNeed Item/Hyperlink Clicks";

NUN_QUESTS_TEXT = "Quests";
NUN_STAGE_TEXT = "Quest Stage ";
NUN_QUEST_GIVER = "Quest Giver";
...
BINDING_NAME_NUN_SRCH = "Browse All Notes";
BINDING_NAME_NUN_PINUP = "Toggle PinUp Tooltip";

NUN_AUTONOTED = " : Noted by NotesUNeed";
NUN_OPT_IMPORT_TOOLTIP =
"This option allows you to import NotesUNeed data from another user.  They must first use the \"Export\" feature to generate the file."
NUN_OPT_EXPORT_TOOLTIP =
"Select this option to export all non-personal notes to a seperate file which you can then email to a friend."
NUN_OPT_RESTORE_TOOLTIP =
"Select this option to begin the process of rebuilding your notes database using an existing backup."
NUN_OPT_BACKUP_TOOLTIP =
"Select this option to open the backup wizard, which will help you save a backup of your notes database."
NUN_OPT_CREATE_TARGET_NOTE_SILENT =
"Creates/updates a note for the current target, but does not open the note for viewing.";
...
NUN_SLOWSERVER = "Slow Server Response Retrieving Quest Text. Please try again. ";
NUN_NOROOM = "No Room to store entire transmission log";

NUN_LEVEL = "Level";
NUN_PROF = "Profession";
NUN_CONTACT_TXT = "Contact Note";
NUN_GENERAL_TXT = "General Note";

NUN_LIMITED = "(Limited Availibility)";

NUN_PARTIED_WITH = "Parties :";

NUN_LINKFAILURE = "Unknown Note Type : Can not process HyperLinks";
NUN_NOLINKS = "No HyperLinks detected in Note";

NUN_POPUP_TITLE = "NotesUNeed";
NUN_MERGING = "Merging...";

NUN_LOADED = "Loaded";
NUN_MAX_MERGED = "Maximum of 5 Notes Merged Already";

NUN_RUN = "Run Script";

NUN_SAVED_NOTIFY1 = "The following note :";
NUN_SAVED_NOTIFY2 = " has been Saved and Closed."
NUN_SAVED_NOTIFY3 = "In order to receive a New Note : "
NUN_RECEIPT_TRUNCATION_WARNING =
"A note that has been sent to you was too long to save properly, and was truncated to fit the maximum length.";
NUN_RECEIVING_START = "A Note has been sent to you from : ";
NUN_RECEIPT_EXPIRED = "Timed Out when receiving Note from : ";

NUN_REPLACE = "Replace\n(Alt-Click to Merge)";
NUN_RECEIPT_PENDING = "Can not accept any more NotesUNeed notes while pending acceptance of earlier note.";
...
NUN_SN_IMPORT_CHOICE = "Alli/Horde";
NUN_SN_FLAG = "~CosmosSocialNote~";

NUN_PRATING = "Player Rating";

NUN_BL_IGNORE = "(Ignore)";
NUN_BL_WARN = "(Warn)";

NUN_CHANGE_RATING = "|cffff0000<Control>-Click to Change|r";
NUN_CHANGE_RATING_CUSTOM = "|cffff0000<Alt>-Click to Reset|r";
NUN_CHOOSE_RATING = "Amend Rating";
NUN_CHOOSE_RATING_TEXT = "Amend Rating Tooltip";

NUN_POPUP_TOGGLE = "|cff00ff00<Open Note>|r";
NUN_PR_TP = "Team Player";
NUN_PR_MB = "Mr. Bean";
...
NUN_ORATINGS_TEXT = {
	...
	"Always wandering off,  pulling adds from every direction",
	"Begs for every drop as they  have an Alt/Sibling that REALLY needs it...",
	"Has an irresistable urge to go and kill mobs,  believing in their own god-like invincibility.  After each kill, they immediately go off in search of the next one,  not caring what the rest of their party is doing.  Usually results in their death and party wipe,  and is almost always followed by  \"Where was my heal?\"",
	"Periodically announces \"BRB\" and disappears for minutes at a time. Often makes up for his absence on his return,  by running head first in to the next mob without warning the party",
	"You never know what this player actually looks like,  as their locator dot is always half a zone away",
	"Runs at top speed toward every, chest, quest objective, or shiny bauble,  usually resulting in Adds, a scattered group, and a Wipe",
	"Moans at every opportunity,  usually about anyone who dares to roll on drops they want",
	"Begs for every magic item after the roll, in order to disenchant it.",
	"Related to the Roadrunner, but will also roll on every BoP item,  whether they can use it or not;  And will grab every chest/item they can. KoS",
	"When they aren't targetting sheep,  they are hitting mobs that are trapped, sapped, or asleep",
	"",
	"",
	"",
	"Kill on Sight",
...
NuNC.NUN_HELP_TEXT1                    =
"|cff00ff00Use |r|cffffffff/nun|r|cff00ff00 without any arguments to toggle the NotesUNeed Options Window.|r";
...
NuNC.NUN_HELP_TEXT5                    =
" |cffffffff<Contact/Note Name>|r|cff00ff00: entering a note name will display that Contact's note if one has been saved, or display the General note of that name if one has been saved.|r";
NuNC.NUN_HELP_TEXT6                    =
" |cffffffff-t|r|cff00ff00: will Generate a Contact note for your current target, if you have targetted a valid player controlled character.|r";
NuNC.NUN_HELP_TEXT7                    =
" |cffffffff-g <Note Title>|r|cff00ff00: will Generate a Generic note with the title provided, or display the note if it already exists.|r";
NuNC.NUN_HELP_TEXT8                    = " |cffffffff-tt|r|cff00ff00: will Toggle NotesUNeed ToolTips on/off.|r";
NuNC.NUN_HELP_TEXT9                    =
" |cffffffff-ca <Contact Name>  OR  -ch <Contact Name>|r|cff00ff00: will Create an Alliance or Horde Contact note respectively for the provided name, without Validation !|r";
...
NuNC.NUN_HELP_TEXT14                   =
" |cffffffff-resetlists|r|cff00ff00: reset NotesUNeed Details to current player's Friends/Ignores|r";                            -- ??
...
NuNC.NUN_INCLUDEINTOOLTIP_TOOLTIP_TXT2 =
"Add this value to the tooltip that appears when mousing over the note's name in the note search dialog.";
...
NuNC.NUN_TT_CHATFORMATCHECK_TXT4       =
" ! Formatted Note details will still be visible to channel subscribers without NotesUNeed ! ";
...
NuNC.NUN_TT_MERGE_TXT1                 = "Merge Notes into single field";
NuNC.NUN_TT_MERGE_TXT2                 = "  Use to merge the notes into a single field in SavedVariables";
...
NuNC.NUN_TT_MAINTAIN_TXT2              =
"  NotesUNeed will maintain a single set of Friends/Ignores for all your Alts.\n  e.g. Add a Friend to one Alt, and NotesUNeed will automatically try to Add that Friend when you log in as a different Alt on the same Realm."; -- ??
NuNC.NUN_TT_VERBOSE_TXT1               = "Silent Friend/Ignore List Maintenance";                                                                                                                                                -- ??
NuNC.NUN_TT_VERBOSE_TXT2               =
"  Check to stop receiving extra messages informing you of when NotesUNeed is adding/removing Friends/Ignores.";                                                                                                                 -- ??
...
NuNC.NUN_TT_GRV_TXT2                   =
" Echoes total number of members and\n names of members leaving / joining since\n last data refresh";
...
NuNC.NUN_TT_MODCB_TXT2                 =
" Use the key combination/mouse combination below\n to Create/Open Notes from Container Items\n or Item/Player Links";
